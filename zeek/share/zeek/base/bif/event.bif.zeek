...
global connection_flipped: event(c: connection );
...
global analyzer_confirmation_info: event(atype: AllAnalyzers::Tag , info: AnalyzerConfirmationInfo );
...
##
## .. zeek:see:: is_protocol_analyzer is_packet_analyzer is_file_analyzer
global analyzer_violation_info: event(atype: AllAnalyzers::Tag , info: AnalyzerViolationInfo );
...
global signature_match: event(state: signature_state , msg: string , data: string , end_of_match: count );
...
global unknown_protocol: event(analyzer_name: string , protocol: count , first_bytes: string , analyzer_history: string_vec );

global unknown_protocol: event(analyzer_name: string , protocol: count , first_bytes: string ) &deprecated="Remove in v8.1. Use the version that includes analyzer_history.";
...
global packet_not_processed: event(pkt: pcap_packet );
