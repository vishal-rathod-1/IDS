...
## fc: function code.
##
global dnp3_application_request_header: event(c: connection , is_orig: bool , application: count , fc: count );
...
##
global dnp3_application_response_header: event(c: connection , is_orig: bool , application: count , fc: count , iin: count );
...
##
global dnp3_header_block: event(c: connection , is_orig: bool , len: count , ctrl: count , dest_addr: count , src_addr: count );
...
global dnp3_frozen_counter_32wFlagTime: event(c: connection , is_orig: bool , flag: count , count_value: count , time48: count );


## Generated for DNP3 objects with the group number 21 and variation number 6
## frozen counter 16 bit with flag and time
global dnp3_frozen_counter_16wFlagTime: event(c: connection , is_orig: bool , flag: count , count_value: count , time48: count );
...
global dnp3_frozen_analog_input_32wTime: event(c: connection , is_orig: bool , flag: count , frozen_value: count , time48: count );


## Generated for DNP3 objects with the group number 31 and variation number 4
## frozen analog input 16 bit with time-of-freeze
global dnp3_frozen_analog_input_16wTime: event(c: connection , is_orig: bool , flag: count , frozen_value: count , time48: count );
...
global dnp3_analog_input_event_32wTime: event(c: connection , is_orig: bool , flag: count , value: count , time48: count );


## Generated for DNP3 objects with the group number 32 and variation number 4
## analog input event 16 bit with time
global dnp3_analog_input_event_16wTime: event(c: connection , is_orig: bool , flag: count , value: count , time48: count );
...
global dnp3_analog_input_event_SPwTime: event(c: connection , is_orig: bool , flag: count , value: count , time48: count );
...
global dnp3_analog_input_event_DPwTime: event(c: connection , is_orig: bool , flag: count , value_low: count , value_high: count , time48: count );
...
global dnp3_frozen_analog_input_event_32wTime: event(c: connection , is_orig: bool , flag: count , frozen_value: count , time48: count );


## Generated for DNP3 objects with the group number 33 and variation number 4
## frozen analog input event 16 bit with time
global dnp3_frozen_analog_input_event_16wTime: event(c: connection , is_orig: bool , flag: count , frozen_value: count , time48: count );
...
global dnp3_frozen_analog_input_event_SPwTime: event(c: connection , is_orig: bool , flag: count , frozen_value: count , time48: count );
...
global dnp3_frozen_analog_input_event_DPwTime: event(c: connection , is_orig: bool , flag: count , frozen_value_low: count , frozen_value_high: count , time48: count );
