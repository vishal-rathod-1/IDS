...
global rdpeudp_syn: event(c: connection );


## Generated for RDPEUDP SYNACK UDP Datagram
##
## c: The connection record for the underlying transport-layer session/flow.
global rdpeudp_synack: event(c: connection );
...
global rdpeudp_established: event(c: connection , version: count );
...
global rdpeudp_data: event(c: connection , is_orig: bool , version: count , data: string );
...
global rdp_native_encrypted_data: event(c: connection , orig: bool , len: count );
...
global rdp_connect_request: event(c: connection , cookie: string , flags: count );
...
global rdp_negotiation_response: event(c: connection , security_protocol: count , flags: count );
...
##
## flags: The flags set by the server.
global rdp_negotiation_failure: event(c: connection , failure_code: count , flags: count );
...
global rdp_client_security_data: event(c: connection , data: RDP::ClientSecurityData );
...
global rdp_client_network_data: event(c: connection , channels: RDP::ClientChannelList );
...
##
## data: The data contained in the client security data structure.
global rdp_client_cluster_data: event(c: connection , data: RDP::ClientClusterData );
