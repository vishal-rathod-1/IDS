...
global krb_as_request: event(c: connection , msg: KRB::KDC_Request );
...
##    krb_ap_response krb_priv krb_safe krb_cred krb_error
global krb_as_response: event(c: connection , msg: KRB::KDC_Response );
...
##    krb_ap_response krb_priv krb_safe krb_cred krb_error
global krb_tgs_request: event(c: connection , msg: KRB::KDC_Request );
...
##    krb_ap_response krb_priv krb_safe krb_cred krb_error
global krb_tgs_response: event(c: connection , msg: KRB::KDC_Response );
...
##    krb_ap_response krb_priv krb_safe krb_cred krb_error
global krb_ap_request: event(c: connection , ticket: KRB::Ticket , opts: KRB::AP_Options );
...
global krb_ap_response: event(c: connection );
...
global krb_priv: event(c: connection , is_orig: bool );
...
global krb_safe: event(c: connection , is_orig: bool , msg: KRB::SAFE_Msg );
...
global krb_cred: event(c: connection , is_orig: bool , tickets: KRB::Ticket_Vector );
...
global krb_error: event(c: connection , msg: KRB::Error_Msg );
