...
global smb2_write_request: event(c: connection , hdr: SMB2::Header , file_id: SMB2::GUID , offset: count , length: count );
...
##
## .. zeek:see:: smb2_message
global smb2_write_response: event(c: connection , hdr: SMB2::Header , length: count );
