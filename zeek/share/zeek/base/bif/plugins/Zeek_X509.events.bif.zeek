...
global x509_ocsp_ext_signed_certificate_timestamp: event(f: fa_file , version: count , logid: string , timestamp: count , hash_algorithm: count , signature_algorithm: count , signature: string );
