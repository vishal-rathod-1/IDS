...
##    entities.
global http_header: event(c: connection , is_orig: bool , original_name: string , name: string , value: string );
...
##    http_entity_data http_event http_header http_message_done http_reply
##    http_request
global http_connection_upgrade: event(c: connection , protocol: string );
