...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global nfs_proc_sattr: event(c: connection , info: NFS3::info_t , req: NFS3::sattrargs_t , rep: NFS3::sattr_reply_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global nfs_proc_symlink: event(c: connection , info: NFS3::info_t , req: NFS3::symlinkargs_t , rep: NFS3::newobj_reply_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global nfs_proc_link: event(c: connection , info: NFS3::info_t , req: NFS3::linkargs_t , rep: NFS3::link_reply_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global nfs_proc_rename: event(c: connection , info: NFS3::info_t , req: NFS3::renameopargs_t , rep: NFS3::renameobj_reply_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global mount_proc_null: event(c: connection , info: MOUNT3::info_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global mount_proc_mnt: event(c: connection , info: MOUNT3::info_t , req: MOUNT3::dirmntargs_t , rep: MOUNT3::mnt_reply_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global mount_proc_umnt: event(c: connection , info: MOUNT3::info_t , req: MOUNT3::dirmntargs_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global mount_proc_umnt_all: event(c: connection , info: MOUNT3::info_t , req: MOUNT3::dirmntargs_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global mount_proc_not_implemented: event(c: connection , info: MOUNT3::info_t , proc: MOUNT3::proc_t );
...
##    been ported. To still enable this event, one needs to
##    register a port for it or add a DPD payload signature.
global mount_reply_status: event(n: connection , info: MOUNT3::info_t );
